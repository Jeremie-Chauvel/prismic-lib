...
export interface AccordionSliceDefaultPrimary {
  ...
  /**
   * subtitle field in *Accordion → Primary*
   *
   * - **Field Type**: Text
...
export interface BioSliceDefaultPrimary {
   ...
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: John is a software engineer with over 10 years of experience.
  ...
  /**
   * picture field in *Bio → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bio.primary.picture
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  picture: prismic.ImageField<never>;

  /**
   * twitter field in *Bio → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: bio.primary.twitter
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  twitter: prismic.LinkField;

  /**
   * github field in *Bio → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
  ...
  /**
   * name field in *Bio → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: John Doe
   * - **API ID Path**: bio.primary.name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  name: prismic.KeyTextField;

  /**
   * title field in *Bio → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Software engineer
   * - **API ID Path**: bio.primary.title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;
}
...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Call To Action Link field in *Hero → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.primary.callToAction
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  callToAction: prismic.KeyTextField;

  /**
   * First Image field in *Hero → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.primary.firstImage
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  firstImage: prismic.ImageField<never>;

  /**
   * Second Image field in *Hero → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.primary.secondImage
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
export interface TerminalSliceDefaultPrimary {
  /**
   * title field in *Terminal → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Terminal
   * - **API ID Path**: terminal.primary.title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;

  /**
   * text field in *Terminal → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: jeremiec:devprojects$
   * - **API ID Path**: terminal.primary.text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
